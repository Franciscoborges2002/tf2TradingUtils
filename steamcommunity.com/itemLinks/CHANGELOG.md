...
- Added mannco.store, skinport.com, marketplace.tf, next.bp.tf stats, and bp.tf/next.bp.tf History links (the last two keyed by the item's asset id, parsed out of the "Inspect in Game" link)
